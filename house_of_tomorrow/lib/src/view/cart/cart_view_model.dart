...
class CartViewModel extends BaseViewModel<CartViewState> {
  @override
  CartViewState build() => CartViewState(isBusy: false,
  ...
  /// 최종 가격
  String get totalPrice => selectedCartItemList.isEmpty
        ? '0'
        : IntlHelper.currency(
            symbol: cartService.selectedCartItemList.first.product.priceUnit,
            number: cartService.selectedCartItemList.fold(0, (prev, curr) => prev + curr.count * curr.product.price),
          );
